...
/*
 select school.name,school.streetname,school.owner,school.email,school.phone,staff.name,staff.phone_number,staff.email,staff.position,staff.gender,staff.age,staff.profile_image from
 school,staff where staff.school_id=school.id and school.id=1
 */
